...
MobileAdapter.prototype = {
  ...
  // This is primarily used by the native app if the recording stops
  // unexpectedly.  The most common case is that the recording is
  // interupted by a phone call.
  //
  // It is triggered every time the native recorder stops so we check
  // that media-recorder hasn't already been stopped by the user directly.
