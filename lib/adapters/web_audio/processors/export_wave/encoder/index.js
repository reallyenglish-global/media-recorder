...
// only supports single channel buffer
function encodeWave(buffer, sampleRate = SAMPLE_RATE) {
  ...
  view.setUint32(28, (sampleRate * bitSize * NUM_CHANNELS) / 8, true)
