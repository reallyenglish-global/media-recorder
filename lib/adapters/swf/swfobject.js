...
module.exports = (function() {
  ...
  var M = (function() {
    ...
    var ah = t.userAgent.toLowerCase()
    var Y = t.platform.toLowerCase()
    var ae = Y ? /win/.test(Y) : /win/.test(ah)
    var ac = Y ? /mac/.test(Y) : /mac/.test(ah)
    var af = /webkit/.test(ah) ? parseFloat(ah.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, '$1')) : false
    var X = !+'\v1'
    var ag = [0, 0, 0]
    var ab = null
