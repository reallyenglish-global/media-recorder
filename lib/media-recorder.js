...
_.extend(Recorder.prototype, observable, {
  ...
  // Decides if the client can record in native web audio or not
  //
  // @note Falls back on flash if page is non-secure
  //       Non-secure pages will also trigger microphone permission to be triggered every time in most browsers
