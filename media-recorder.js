...
var MediaRecorderFlash = function(options) {
  this.initialize.call(this, options);
};

MediaRecorderFlash.prototype.initialize = function(cfg) {
...
MediaRecorderFlash.prototype._setupFlashContainer = function() {
...
MediaRecorderFlash.prototype._showFlashRequiredDialog = function() {
...
MediaRecorderFlash.prototype._loadFlash = function() {
...
MediaRecorderFlash.prototype._hideFlash = function() {
  this.flashContainer.style.left = "-9999px";
  this.flashContainer.style.top  = "-9999px";
};

MediaRecorderFlash.prototype.record = function() {
  this.flashInterface().recordStart();
};

MediaRecorderFlash.prototype.play = function() {
  this.flashInterface().playback();
};

MediaRecorderFlash.prototype.stop = function() {
  return this.flashInterface().recordStop();
};

MediaRecorderFlash.prototype.flashInterface = function() {
  if(!this.swfObject){
    return null;
...
MediaRecorderFlash.prototype.bind = function(eventName, fn){
  if(!this._events[eventName]){ this._events[eventName] = [] }
  this._events[eventName].push(fn);
};

MediaRecorderFlash.prototype.triggerEvent = function(eventName, arg0, arg1){
