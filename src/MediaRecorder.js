...
MediaRecorder.prototype.initialize = function(cfg) {
...
MediaRecorder.prototype.prepare = function prepare(stream) {
...
MediaRecorder.prototype.onAudioProcess = function onAudioProcess(e) {
...
MediaRecorder.prototype.record = function record() {
  this.clear();
  this.recording = true;
};

MediaRecorder.prototype.clear = function clear() {
  this.recLength = 0;
  this.recBuffersL = [];
  this.recBuffersR = [];
};

MediaRecorder.prototype.getBuffer = function getBuffer() {
  var buffers = [];
...
MediaRecorder.prototype.mergeBuffers = function mergeBuffers(recBuffers, recLength){
...
MediaRecorder.prototype.play = function play() {
